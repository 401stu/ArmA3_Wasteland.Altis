/*
 ...
 By BangaBob v0.5 
 (stripped down abit for A3Wasteland usage by JoSchaap)
 
 null=[] execVM "addons/cos/cosInit.sqf";
...
blackListTowns = ["Pythos"];// Remove towns from COS
...
// if (!_showMarker) then {}else{_foo setmarkerAlpha 0.5;};// Show or hide marker
	

// Get positions until we have enough for the population
 _roadlist = _pos nearRoads _mSize;
 _minPositions=(_civilians+_slack);
...
// Save all information
	_information=[_civilians,_roadPosArray];
